...
class PresentationViewController: UIViewController,AVCaptureVideoDataOutputSampleBufferDelegate, SFSpeechRecognizerDelegate {
    ...
    @IBOutlet weak var newBB: UIImageView!
    @IBOutlet weak var newBB2: UIImageView!
    ...
    //
    @IBOutlet weak var leftG: UIImageView!
    @IBOutlet weak var rightG: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        self.view.bringSubview(toFront: label22)
        ...
        let request = VNCoreMLRequest(model: model) { (finishedReq, err) in
            ...
            DispatchQueue.main.async {
                ...
                if(self.startTheSession == true)
                {
                    ...
                    questions.append("What is a singleton class?")
                    questions.append("What are the steps for creating the object?")
                    questions.append("What is the different type of access modifiers?")
                    questions.append("Which is the highest operator precedence in Java?")
                    questions.append("What is the difference between equals() and method and == operator?")
                    questions.append("What is a Byte stream?")
                    questions.append("What is a file?")
                    questions.append("What is a constructor?")
                    questions.append("What is inheritance?")
                    questions.append("Compare method and constructor?")
                    questions.append("What are instance and class variables?")
                    questions.append("What is a wrapper class?")
                    questions.append("Difference between class and interface?")

                    
                    //Ask question
                    if(self.count%50 == 0){
                        self.label22.alpha = 0
                        self.label22.isHidden = false
                        
                        self.label22.text = questions[self.questionCount]
                        self.questionCount = self.questionCount + 1
                        
                        if(self.questionCount == 12){
                            self.questionCount = 0
                        }
                        
                        UIView.animate(withDuration: 0.3, animations: {
                          self.label22.alpha = 1
                        }) { (finished) in
...
//                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               c2self.previewLayer?.isHidden = true
    ...
    @IBAction func buttonA(_ sender: UIButton) {
        ...
        if(endButton.isHidden){
             ...
             startRecording() //
            newBB.isHidden = true
            newBB2.isHidden = true
            leftG.isHidden = true
            rightG.isHidden = true
    ...
    @IBAction func endButtonAction(_ sender: UIButton) {
        ...
        newBB.isHidden = false
        newBB2.isHidden = false
        leftG.isHidden = false
        rightG.isHidden = false
        audioEngine.stop()
